...
from dags.dags_utils import create_table_from_csv
...
(create_sales_management_dataset_task >> create_customers_table_task)
(create_sales_management_dataset_task >> create_products_table_task)
(create_sales_management_dataset_task >> create_purchases_table_task)
